    ...
    public static void main(String[] args) {
        ...
        while (opcion != 7) {
            ...
            if (opcion >= 1 && opcion <= 6) {
                ...
                String url = getUrl.generaUrl(fromCurrency, toCurrency);
                try {
                    String respuesta = datosApi.enviarGet(url);
                    String resultado = extractor.extract(respuesta, toCurrency, cantidad);
                    System.out.println("El valor de " + cantidad + " [" + fromCurrency + "] es de: " + resultado + " [" + toCurrency + "]");
                } catch (Exception e) {
